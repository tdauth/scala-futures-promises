...
abstract class AbstractFPTest extends AbstractUnitSpec {
  ...
  "tryFail" should "complete a future with an exception" in {
    ...
    the[RuntimeException] thrownBy p.getP should have message "test"
  }
  ...
  it should "create a failed future" in {
    ...
    p.trySuccess(10)
    the[RuntimeException] thrownBy s.getP should have message "test"
  }
  ...
  it should "create a failed future by the first one" in {
    ...
    the[RuntimeException] thrownBy s.getP should have message "test 0"
  }
  ...
  "guard" should "throw the exception PredicateNotFulfilled" in {
    ...
    p.trySuccess(10)
    the[PredicateNotFulfilled] thrownBy future.getP should have message null
  }
  ...
  it should "throw the initial exception" in {
    ...
    the[RuntimeException] thrownBy future.getP should have message "test"
  }
  ...
  it should "complete the final future with the first one over the second one when both are failing" in {
    ...
    val f = p0.orAlt(p1)
    the[RuntimeException] thrownBy f.getP should have message "test 0"
  }
  ...
  it should "complete the final future with the second one although it fails" in {
    ...
    val p0 = getFP
    val f = p0.first(p1)
    the[RuntimeException] thrownBy f.getP should have message "test 1"
  }
  ...
  it should "complete the final future with the second one" in {
    val p0 = getFP
    p0.tryFail(new RuntimeException("test"))
    the[RuntimeException] thrownBy p0.getP should have message "test"
    val p1 = getFP
    p1.trySuccess(11)
    val f = p0.firstSucc(p1)
    f.getP should be(11)
  ...
  it should "complete with the exception of the second future" in {
    val p0 = getFP
    p0.tryFail(new RuntimeException("test 0"))
    the[RuntimeException] thrownBy p0.getP should have message "test 0"
    val p1 = getFP
    val f = p0.firstSucc(p1)
    p1.tryFail(new RuntimeException("test 1"))
    the[RuntimeException] thrownBy f.getP should have message "test 1"
  ...
  it should "complete with the exception of the first future" in {
    val p1 = getFP
    p1.tryFail(new RuntimeException("test 1"))
    the[RuntimeException] thrownBy p1.getP should have message "test 1"
    val p0 = getFP
    val f = p0.firstSucc(p1)
    p0.tryFail(new RuntimeException("test 0"))
    the[RuntimeException] thrownBy f.getP should have message "test 0"
